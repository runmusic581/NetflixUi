...
const Row = ({ title, fetchURL, rowId }) => {
  ...
  return (
    <>
      <h2 className="text-white left-0 font-bold md:text-xl p-4">{title}</h2>
      <div className="relative flex items-center group">
        ...
        <div id={"slider" + rowId} className="w-full h-full overflow-x-scroll scrollbar-hide whitespace-nowrap scroll-smooth  relative">
          {movies.map((item, id) => {
            return (
             <>
